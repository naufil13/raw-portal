...
var KTApexChartsDemo = function () {
	...
	var _demo2 = function () {
		...
		var options = {
			series: [{
				...
				name: 'Approved',
				data: [100, 10, 48, 11, 62, 9, 2]
			},

            {
				name: 'Completed',
				data: [21, 60, 88, 91, 112, 19, 10]
			},
            {
				name: 'Declined',
				data: [55, 34, 8, 77, 66, 120, 7]
			}
            ],
			chart: {
				height: 350,
			...
			xaxis: {
				type: 'text',
				categories: ["1 jul 2021","2 jul 2021","3 jul 2021","4 jul 2021","5 jul 2021","6 jul 2021","7 jul 2021"]
			},
			tooltip: {
				x: {
	...
	var _demo4 = function () {
		...
		var options = {
			series: [{
				name: 'Pending',
				data: [44, 55, 41, 37, 22, 43, 21,19,33,41]
			}, {
				name: 'Completed',
				data: [53, 32, 33, 52, 13, 43, 32,44,22,11]
			}, {
				name: 'Approved',
				data: [12, 17, 11, 9, 15, 11, 20,18,28,13]
			}, {
				name: 'Declined',
				data: [9, 7, 5, 8, 6, 9, 4,2,8,12]
			}],
			chart: {
				type: 'bar',
				height: 350,
			...
			xaxis: {
				categories: ['Al Arabiya', 'Tag 91', 'Dubai 92', 'Kadak FM', 'Radio Shoma', 'Club FM', 'Beat FM','Big FM','Al Khaleejiya'],
