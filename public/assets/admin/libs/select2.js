var KTSelect2 = {
    init: function () {
        $(".kt_select2_1, .kt_select2_1_validate").select2({placeholder: "Select Option"}), $("#kt_select2_2, #kt_select2_2_validate").select2({placeholder: "Select Option"}), $("#kt_select2_3, #kt_select2_3_validate").select2({placeholder: "Select Option"}), $("#kt_select2_4").select2({
            ...
            $(".kt_select2_1_modal").select2({placeholder: "Select Option"}), $("#kt_select2_2_modal").select2({placeholder: "Select Option"}), $("#kt_select2_3_modal").select2({placeholder: "Select Option"}), $("#kt_select2_4_modal").select2({
                placeholder: "Select Option",
                allowClear: !0
            })
        })
