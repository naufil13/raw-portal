...
var KTTreeview = {
    init: function () {
        $("#kt_tree_1").jstree({
            ...
            core: {themes: {responsive: !1}},
            types: {default: {icon: "fa fa-folder kt-font-warning"}, file: {icon: "fa fa-file  kt-font-warning"}},
            plugins: ["types"]
            ...
            core: {
                ...
                data: [{
                    ...
                    }, {text: "custom icon", icon: "fa fa-warning kt-font-waring"}, {
                        text: "disabled node",
            ...
            types: {default: {icon: "fa fa-folder kt-font-brand"}, file: {icon: "fa fa-file  kt-font-brand"}},
            state: {key: "demo2"},
            ...
            types: {default: {icon: "fa fa-folder kt-font-success"}, file: {icon: "fa fa-file  kt-font-success"}},
            state: {key: "demo2"},
